...
export default function Deals() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-5">
      <section className="mt-10 flex flex-col md:flex-row max-w-[1200px] justify-between bg-neutral-900  px-5">
        <div className="py-8 px-3 lg:px-16 text-center md:text-left">
          <p className="text-white">ONLINE EXCLUSIVE</p>
          <h2 className="pt-6 text-5xl font-bold text-sky-500">25% OFF</h2>
          <p className="pt-4 text-white">
            ELEGANCE, <br />
            IN EVERY TOUCH
          </p>
          <button
            className="mt-6 bg-sky-500 px-4 py-2 duration-100 "
            onClick={handleClick}
          >
            Shop now
          </button>
